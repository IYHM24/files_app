...
// Librería de iconos reutilizables para las cards
export const Icons = {
  // Files & Documents
  File: () => (
  ...
  // Emojis como iconos alternativos
  Emoji: {
    Lightning: () => <span className="text-lg">⚡</span>,
    ...
    CheckMark: () => <span className="text-lg">✅</span>,
    Cross: () => <span className="text-lg">❌</span>,
    Warning: () => <span className="text-lg">⚠️</span>,
    Info: () => <span className="text-lg">ℹ️</span>,
    Question: () => <span className="text-lg">❓</span>,
    Gear: () => <span className="text-lg">⚙️</span>,
    ...
    Graph: () => <span className="text-lg">📈</span>,
    ...
    Location: () => <span className="text-lg">📍</span>,
  }
};